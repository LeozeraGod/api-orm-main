...
export class Migration1743634747594 implements MigrationInterface {
    name = 'Migration1743634747594'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "accounts" ("id" SERIAL NOT NULL, "account_number" integer NOT NULL, "agency_number" integer NOT NULL, "user_id" integer, CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`);
